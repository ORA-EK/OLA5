...
stoptime <- Sys.time() + 180   # kør i 60 sekunder (ret hvis du vil)
...
###### Fordi vi ikke har et sd kort til at lagere data, har vi oprettet en CSV fil
####### til både lego forsøget og bibloteksforsøget

#write.csv(df_nb, "C:/Users/marol/Dataanalyse 1. sem/R/OLA/OLA 5/data_nb.csv", row.names = FALSE)


library(ggplot2)

ggplot(data_nb, aes(x = timestamp, y = distance, fill = factor(person_id))) +
  geom_col() +
